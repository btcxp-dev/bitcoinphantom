...
// Copyright (c) 2019-2020, The Bitcoinphantom developers
//
...
//
// Bitcoinphantom is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
// GNU Lesser General Public License for more details.
//
// You should have received a copy of the GNU Lesser General Public License
// along with Bitcoinphantom.  If not, see <http://www.gnu.org/licenses/>.
...
const size_t CRYPTONOTE_COIN_VERSION                         = 1.1;
...
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_V2  = 300000;
const size_t   CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_V1  = 300000;
...
const uint32_t MIN_TX_MIXIN_V1_HEIGHT                        = 21796;
const uint32_t MIN_TX_MIXIN_V2_HEIGHT                        = 217888;
...
const size_t   DIFFICULTY_WINDOW_V4                          = 80; // blocks
...
const size_t   MAX_BLOCK_SIZE_INITIAL                        = 2000000;
const uint64_t MAX_BLOCK_SIZE_GROWTH_SPEED_NUMERATOR         = 200 * 1024;
...
const char     GENESIS_COINBASE_TX_HEX[]                     = "010a01ff00002101c373f9ca1182aaddd7b8bee794ec8eecd9d7c9e6a3da316625836da8ef674589";
const char     DNS_CHECKPOINTS_HOST[]                        = "checkpoints.Bitcoinphantom.org";
...
const int      P2P_DEFAULT_PORT                              =  47667;
const int      RPC_DEFAULT_PORT                              =  47669;
...
const uint32_t P2P_DEFAULT_HANDSHAKE_INTERVAL                = 40;            // seconds
...
const uint32_t P2P_IDLE_CONNECTION_KILL_INTERVAL             = (3 * 60);      //3 minutes

const char     P2P_STAT_TRUSTED_PUB_KEY[]                    = "8f80f9a5a434a9f1510d13336228debfee9c918ce505efe225d8c94d045fa115";

const char* const SEED_NODES[] = {
  "35.239.137.57:47667",
  "35.192.221.142:47667"
};
